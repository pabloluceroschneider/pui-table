...
var TBody = function () {
    ...
    (0, useDragAndDrop_1.useDragAndDrop)();
    return (react_1.default.createElement("tbody", { className: bodyClasses }, data.map(function (row, index) { return (react_1.default.createElement(TRow_1.default, { key: index }, headers.map(function (header) {
