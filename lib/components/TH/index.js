...
var THeader = function (_a) {
    ...
    var className = state.className, onOrderByColumn = state.onOrderByColumn;
    var onOrderBy = actions.onOrderBy;
    var _c = (0, react_1.useState)(false), isDesc = _c[0], setIsDesc = _c[1];
    ...
    var headeronOrderByClasses = (0, classnames_1.default)(className, 't-header__order-by', {
    ...
    return (react_1.default.createElement("th", { onClick: handleOrder, className: headerClasses, style: { width: header.width } },
        react_1.default.createElement("div", { className: headercontainerClasses },
            ...
            react_1.default.createElement("div", { className: headeronOrderByClasses }, isDesc ? '↓' : '↑'))));
};
